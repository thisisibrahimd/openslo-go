...
func NewBudgetAdjustment() *BudgetAdjustment {
...
func (o *BudgetAdjustment) HasApiVersion() bool {
	if o != nil && !IsNil(o.ApiVersion) {
		return true
	}
...
func (o *BudgetAdjustment) HasKind() bool {
	if o != nil && !IsNil(o.Kind) {
		return true
	}
...
func (o *BudgetAdjustment) HasMetadata() bool {
	if o != nil && !IsNil(o.Metadata) {
		return true
	}
