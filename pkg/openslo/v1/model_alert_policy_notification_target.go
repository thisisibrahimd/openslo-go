...
func NewAlertPolicyNotificationTarget(apiVersion OpensloApiVersion, kind AlertNotificationTargetKind, metadata Metadata, spec AlertNotificationTargetSpec) *AlertPolicyNotificationTarget {
